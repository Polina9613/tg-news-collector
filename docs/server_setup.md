...
Плюсы: быстрый, не нужен свой сервер.
Минусы: лимит 30 запросов/минуту на бесплатном тарифе.

### Ollama (свой сервер)

```env
LLM_PROVIDER=ollama
LLM_BASE_URL=http://your-server.com:11434
LLM_MODEL=qwen2.5:14b
LLM_TIMEOUT=120
```

Плюсы: без лимитов, данные не уходят наружу.
Минусы: нужен GPU-сервер с установленной моделью.

Рекомендуемые модели для русского текста:
- `qwen2.5:14b` — хороший баланс качества и скорости
- `gemma3:12b` — быстрее, чуть слабее по качеству
- `llama3.3:70b` — лучшее качество, нужен мощный GPU (≥24 GB VRAM)

Проверить доступность и сделать тестовый запрос:
